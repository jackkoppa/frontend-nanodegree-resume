...
resume["data"] = {
  "bio": {
    ...
    "skills": ["HTML", "CSS", "JavaScript", "jQuery", "WordPress", "PHP", "Sass", "React.js", "Backbone.js"],
  ...
  "work": {
    "jobs": [{
      ...
      "urls": ["http://embarkchina.org/En_US/"]
    }, {
      ...
      "urls": ["http://jackkoppa.com/work/power-test-inc/"]
    }, {
      ...
      "urls": ["http://jackkoppa.com/work/apbo/"]
    }, {
      ...
      "urls": ["http://jackkoppa.com/work/global-clean-vehicle/"]
    }, {
  ...
  "projects": {
    "projects": [{
      ...
      "skills": ["WordPress", "PHP", "JavaScript", "HTML", "CSS", "jQuery", "PhotoShop"],
      "description": {
      ...
      "imgDir": "chanje",
      "images": ["chanje_home.jpg", "chanje_models.jpg", "chanje_team.jpg", "chanje_impact.jpg", "chanje_key_features.jpg", "chanje_connect.jpg"],
      "urls": ["http://chanje.us"]
    }, {
      "title": "Power Test",
      "dates": {
      ...
      "skills": ["WordPress", "PHP", "jQuery", "JavaScript", "HTML", "CSS", "PhotoShop"],
      "description": {
      ...
      "skills": ["JavaScript", "Backbone.js", "Node.js", "Sass", "Parse", "Git", "Grunt", "HTML", "CSS"],
      "description": {
        ...
        "long": ["PixBox is a simple, beautiful, group-oriented photo sharing web application. The goal as conceived by Aadit Patel, my client for the project, is to make shared events easily captured in photos by all attending, with all attending easily accessing the photos taken.", "To tackle the challenge, I project managed a team of 3 other student developers in USC’s capstone web development class. Tiago (Development), Allara (Design), Peter (Development), and myself (PM/Development) needed to provide some essential functionality:", "sign up for account, verification method being SMS", "attractive dashboard, with options to view current albums, join friends’ albums, create a new album, and edit settings", "create album flow that allows for easy invitation of friends to view & contribute, through both SMS (for new accounts) and users (for existing accounts)", "individual album pages display photos, allow for easy sharing & download, as well as user management (add/remove)", "bonus features, such as attractive loading & signup animations, plus profile editing", "We were tasked with the creation of this web app in the Fall of 2015 semester, and to finish, we needed to jump right in. The app would be built with Parse as the backend database, leaving us to choose front-end frameworks, server-side code, styling, and version control. We went with Backbone.js as our MVC framework, for its heavy documentation, ease of implementation with Parse, and low barrier to entry for all four of us. We used a version of Node.js for our server-side JavaScript, SASS for styling, and Git/Jira for version & project management. Throughout, I tried to keep us on a flexible schedule – our client was great about providing design documents, which put us on a great path from the outset. The biggest struggle was changing compatibility standards for Parse, which we managed by staying in consistent contact with each other, updating the team on where we had success and issues, sticking to an agile (weekly sprints) methodology.", "In the end, I was responsible for both project management, and a large portion of the development heavy lifting. With Tiago, I was able to learn the intricacies of Backbone.js, and learned to love it while finishing a fully functional, SMS-integrated photo sharing web app. We are proud of the result, shown above, which matches Aadit’s great vision, and will hopefully be launched to the public in the near future. At the end of the semester, I dove deep into our code, to add additional comments where necessary, and provide a guidance document for Aadit, should he choose to add features in the future. A great experience in team leadership, and creating a product we could be proud of, in about 3 months.", "(PixBox is currently still private, but if you would like to view the app itself, please don’t hesitate to get in touch, and I’d be happy to provide a link/code samples)"]
      },
      "imgDir": "pixbox",
      "images": ["pixbox_album.jpg", "pixbox_dashboard.jpg", "pixbox_invite_members.jpg", "pixbox_login.jpg", "pixbox_mobile.jpg", "pixbox_new_album.jpg"],
      "urls": []
    }, {
      "title": "FrackMented",
      "dates": {
      ...
      "skills": ["WordPress", "PHP", "MySQL", "HTML", "CSS", "jQuery", "JavaScript", "Photoshop"],
      "description": {
        ...
        "long": ["Peaks and Professors is a fairly new organization on USC’s campus – with 3 friends, I helped co-found the club in Summer of 2013. Our goal is to lead hikes for small groups of students, around the SoCal area, each time taking along a different USC Professor. This fosters communication outside the classroom, as well as a great appreciation of nature. Immediately, we realized that the best and most convenient communication route for us would be entirely online, almost entirely on our own website.", "I immediately began searching for appropriate design options, and eventually came across Earth 2.0, a theme on ThemeForest that loosely suited our organization’s goals. Since then, I have been customizing, tweaking, dramatically updating, and personalizing our site, in order to accomplish three main goals: club promotion, ease of use by students, and ease of use by club leaders.", "To that end, peaksandprofessors.org has a variety of unique features: an email newsletter sign-up form on most pages, since that is the most important way for us to reach new student members, a calendar of upcoming trips with multiple views, a filter-able list of Professors, and perhaps most importantly, a completely custom backend. This customized dashboard allows any leader in the club to make edits to trip pages with no coding knowledge, while still keeping design consistent across the site.", "These updates have proved quite successful: since that Summer of 2013, up to May 2016, we have had over 80 trips, have 2,000+ email subscribers, and over 1,500 followers on Facebook. Perhaps most impressively, in 2016 Peaks and Professors was named USC's Student Organization of the Year, out of 800+ clubs. The most consistent comment from people who have signed up for the club? “I love the website!”"]
      },
      "imgDir": "peaks_and_professors",
      "images": ["peaks_and_professors_dashboard.jpg", "peaks_and_professors_individual_trips.jpg", "peaks_and_professors_trips.jpg"],
      "urls": ["http://peaksandprofessors.com", "https://news.usc.edu/99581/no-lectern-no-laptop-no-problem-for-trojans-hiking-on-socals-scenic-trails/"]
    }]
  }
};
...
function formatDate(rawDate) {
  var shortForm = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
//# sourceMappingURL=resumeScripts.js.map
